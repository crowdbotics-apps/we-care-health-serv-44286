...
## Project Structure
    ...
    ├── we_care_health_serv_44286  # Django project configurations
...
1. Clone this repo and `cd we_care_health_serv_44286`
...
2. Clone this repo and `cd we_care_health_serv_44286`
