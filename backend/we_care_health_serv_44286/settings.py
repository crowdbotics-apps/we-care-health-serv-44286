"""
Django settings for we_care_health_serv_44286 project.
...
ROOT_URLCONF = 'we_care_health_serv_44286.urls'
...
WSGI_APPLICATION = 'we_care_health_serv_44286.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "we_care_health_serv_44286 API",
    "DESCRIPTION": "API documentation for we_care_health_serv_44286 App",
    "VERSION": "v1",
}
